...
```bash
python3 scripts/generate_report.py analysis.json outputs/find-customer-report.html
```

Paths are relative to this skill directory; pass absolute paths when in doubt.
Return a clickable absolute file link. Keep the JSON in a work or temporary
directory unless the user asks for raw data.
